...
pygame.display.set_caption('ver3')
...
for i in range(iterations):
    x_places = []
    y_places = []
    # random value on the original picture to pick the color of the to be drawn circle
    ...
    # checks, if there has already been drawn on this pixel
...
print(str(circlecounter) + " circles")
